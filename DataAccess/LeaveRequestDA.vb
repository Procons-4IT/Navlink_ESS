...
Public Class LeaveRequestDA
    ...
    Public Function PageLoadBind(ByVal objen As LeaveRequestEN) As DataSet
        Try
            objDA.strQuery = "Select T0.""Code"" as ""Code"",""U_Z_TrnsCode"",T1.""Name"" as ""Name"",convert(varchar(10),""U_Z_StartDate"",103) AS ""U_Z_StartDate"",convert(varchar(10),""U_Z_EndDate"",103) AS ""U_Z_EndDate"" ,cast(T0.U_Z_NoofDays as decimal(25,2)) AS ""U_Z_NoofDays"",""U_Z_Notes"",convert(varchar(10),""U_Z_ReJoiNDate"",103) AS ""U_Z_ReJoiNDate"",case ""U_Z_Status"" when 'P' then 'Pending' when 'R' then 'Rejected' when 'A' then 'Approved' end as ""U_Z_Status"",""U_Z_AppRemarks"" from ""@Z_PAY_OLETRANS1"" T0 inner join ""@Z_PAY_LEAVE"" T1 on T0.""U_Z_TrnsCode""=T1.""Code"" where ""U_Z_EMPID""='" & objen.Empid & "' and ""U_Z_TransType""='L' order by T0.""Code"" Desc;"
            objDA.strQuery += "Select T0.""Code"" as ""Code"",""U_Z_TrnsCode"",T1.""Name"" as ""Name"",convert(varchar(10),""U_Z_StartDate"",103) AS ""U_Z_StartDate"",convert(varchar(10),""U_Z_EndDate"",103) AS ""U_Z_EndDate"" ,cast(T0.U_Z_NoofDays as decimal(25,2)) AS ""U_Z_NoofDays"",""U_Z_Notes"" from ""@Z_PAY_OLETRANS"" T0 inner join ""@Z_PAY_LEAVE"" T1 on T0.""U_Z_TrnsCode""=T1.""Code"" where ""U_Z_EMPID""='" & objen.Empid & "' and ""U_Z_IsTerm""='N' order by T0.""Code"" Desc"
    ...
    Public Function PopulateLeaveRequest(ByVal objen As LeaveRequestEN) As DataSet
        Try
            objDA.strQuery = "Select T0.""Code"" as ""Code"",""U_Z_TrnsCode"",T1.""Name"" as ""Name"",convert(varchar(10),""U_Z_StartDate"",103) AS ""U_Z_StartDate"",convert(varchar(10),""U_Z_EndDate"",103) AS ""U_Z_EndDate"" ,cast(T0.U_Z_NoofDays as decimal(25,2)) AS ""U_Z_NoofDays"",""U_Z_Notes"",convert(varchar(10),""U_Z_ReJoiNDate"",103) AS ""U_Z_ReJoiNDate"",""U_Z_Status"",ISNULL(""U_Z_LevBal"",0) AS ""U_Z_LevBal"" from ""@Z_PAY_OLETRANS1"" T0 inner join ""@Z_PAY_LEAVE"" T1 on T0.""U_Z_TrnsCode""=T1.""Code""  where ""U_Z_EMPID""='" & objen.Empid & "' and T0.""Code""='" & objen.LeaveCode & "'"
            objDA.sqlda = New SqlDataAdapter(objDA.strQuery, objDA.con)
