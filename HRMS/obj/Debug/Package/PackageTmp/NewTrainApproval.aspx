                                                                            ...
                                                                            <asp:GridView ID="grdRequestApproval" runat="server" CellPadding="4" AllowPaging="True"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Attachment">
                                                                                        <ItemTemplate>
                                                                                            <div align="center">
                                                                                                <asp:LinkButton ID="lnkEDownload" Text="Download" CommandArgument='<%# Eval("U_Z_Attachment") %>'
                                                                                                    ToolTip='<%# Eval("U_Z_Attachment") %>' runat="server" Width="100px" OnClick="lnkEDownload_Click"></asp:LinkButton>
                                                                                            </div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                            ...
                                                                            <asp:GridView ID="grdSummary" runat="server" CellPadding="4" AllowPaging="True" ShowHeaderWhenEmpty="true"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Attachment">
                                                                                        <ItemTemplate>
                                                                                            <div align="center">
                                                                                                <asp:LinkButton ID="lnkSDownload" Text="Download" CommandArgument='<%# Eval("U_Z_Attachment") %>'
                                                                                                    ToolTip='<%# Eval("U_Z_Attachment") %>' runat="server" Width="100px" OnClick="lnkSDownload_Click"></asp:LinkButton>
                                                                                            </div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Approval Required">
