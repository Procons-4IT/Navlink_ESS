<%@ Page Title="Return From Leave Approval" Language="vb" AutoEventWireup="false" MasterPageFile="~/HRMS.Master" CodeBehind="ReturnLeaveApproval.aspx.vb" Inherits="HRMS.ReturnLeaveApproval" %>
...
<table width="99%" border="0" cellspacing="0" cellpadding="4" class="main_content">
 <tr>
    ...
    <td height="30" align="left" colspan="2" valign="bottom" background="images/h_bg.png"; style="border-bottom:1px dotted; border-color: #f45501; background-repeat:repeat-x">     
      <div >&nbsp; <asp:Label ID="Label3" runat="server" Text="Return From Leave Approval"  CssClass="subheader" style="float:left;" ></asp:Label>  <span ><asp:Label ID="lblNewTrip" runat="server" Text="" Visible="false"></asp:Label></span> </div>
      </td>    
 </tr>
                                          ...
                                          <Columns>
                                              ...
                                              <asp:TemplateField HeaderText="No.of Days">
                                               ...
                                               <asp:TemplateField HeaderText="ReJoin Date">
                                                   <ItemTemplate>
                                                        <div align="left">&nbsp;<asp:Label ID="lblrejoindt" runat="server" Text='<%#Bind("U_Z_ReJoiNDate") %>' ></asp:Label></div>
                                                   </ItemTemplate>
                                               </asp:TemplateField>
                                               <asp:TemplateField HeaderText="Return ReJoin Date">
                                                   <ItemTemplate>
                                                         <div align="left">&nbsp;<asp:Label ID="lblRetRejoin" runat="server" Text='<%#Bind("U_Z_RetJoiNDate") %>' ></asp:Label></div>
                                                   </ItemTemplate>
                                               </asp:TemplateField>
                                              <asp:TemplateField HeaderText="Remarks">
                                               ...
                                               <asp:TemplateField HeaderText="Approver Remarks">
                                                   <ItemTemplate>
                                                         <div align="left">&nbsp;<asp:label ID="lblremarks" runat="server" Text='<%#Bind("U_Z_RAppRemarks") %>' ></asp:label></div>
                                                   </ItemTemplate>
                                               </asp:TemplateField>
                                          ...
                                          <Columns>
                                             ...
                                             <asp:TemplateField HeaderText="Emp.Code">
                                              ...
                                              <asp:TemplateField HeaderText="Remarks">
                                               ...
                                               <asp:TemplateField HeaderText="ReJoin Date">
                                                   <ItemTemplate>
                                                        <div align="left">&nbsp;<asp:Label ID="lblsrejoindt" runat="server" Text='<%#Bind("U_Z_ReJoiNDate") %>' ></asp:Label></div>
                                                   </ItemTemplate>
                                               </asp:TemplateField>
                                               <asp:TemplateField HeaderText="Return ReJoin Date">
                                                   <ItemTemplate>
                                                         <div align="left">&nbsp;<asp:Label ID="lblsRetRejoin" runat="server" Text='<%#Bind("U_Z_RetJoiNDate") %>' ></asp:Label></div>
                                                   </ItemTemplate>
                                               </asp:TemplateField>
                                               ...
                                               <asp:TemplateField HeaderText="Approver Remarks">
                                                   <ItemTemplate>
                                                         <div align="left">&nbsp;<asp:label ID="lblsremarks" runat="server" Text='<%#Bind("U_Z_RAppRemarks") %>'></asp:label></div>
                                                   </ItemTemplate>
                                               </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Payroll Month">
                                                  <ItemTemplate>
