<%@ Page Title="Internal Applicants Approval" Language="vb" AutoEventWireup="false" MasterPageFile="~/HRMS.Master" CodeBehind="InternalAppApproval.aspx.vb" Inherits="HRMS.InternalAppApproval" %>
...
<table width="99%" border="0" cellspacing="0" cellpadding="4" class="main_content">
 <tr>
    ...
    <td height="30" align="left" colspan="2" valign="bottom" background="images/h_bg.png"; style="border-bottom:1px dotted; border-color: #f45501; background-repeat:repeat-x">     
      <div >&nbsp; <asp:Label ID="Label3" runat="server" Text="Internal Applicants Approval"  CssClass="subheader" style="float:left;" ></asp:Label>  <span ><asp:Label ID="lblNewTrip" runat="server" Text="" Visible="false"></asp:Label></span> </div>
      </td>    
 </tr>
                                      ...
                                      <asp:GridView ID="grdRequestApproval" runat="server" CellPadding="4" AllowPaging="True" ShowHeaderWhenEmpty="true" EmptyDataText = "No Records Found"  CssClass="mGrid" HeaderStyle-Cssclass="GridBG" PagerStyle-CssClass="pgr"  AlternatingRowStyle-CssClass="alt" AutoGenerateColumns="false" Width="100%" PageSize="10" >
                                          <Columns>
                                             ...
                                             <asp:TemplateField HeaderText="Emp.Id">
                                                <ItemTemplate>
                                                    <div align="left">&nbsp;<asp:Label ID="lblempcode" runat="server" Text='<%#Bind("U_Empid") %>' ></asp:Label></div>
                                                </ItemTemplate>                                    
                                            </asp:TemplateField> 
                                            ...
                                            <asp:TemplateField HeaderText="Emp.Department" Visible="false">
                                                <ItemTemplate>
                                                    <div align="left">&nbsp;<asp:Label ID="lblempdeptcode" runat="server" Text='<%#Bind("U_EmpdeptCode") %>' ></asp:Label></div>
                                                </ItemTemplate>                                    
                                            </asp:TemplateField>                                
                                             <asp:TemplateField HeaderText="Emp.Department">
                                                <ItemTemplate>
                                                    <div align="left">&nbsp;<asp:Label ID="lblempdept" runat="server" Text='<%#Bind("U_EmpdeptName") %>' ></asp:Label></div>
                                                </ItemTemplate>                                    
                                            </asp:TemplateField>
                                               <asp:TemplateField HeaderText="Emp.Position">
                                                <ItemTemplate>
                                                    <div align="left">&nbsp;<asp:Label ID="lblempPos" runat="server" Text='<%#Bind("U_EmpPosName") %>' ></asp:Label></div>
                                                </ItemTemplate>                                    
                                            </asp:TemplateField>
                                               <asp:TemplateField HeaderText="Vacant Department">
                                                <ItemTemplate>
                                                    <div align="left">&nbsp;<asp:Label ID="lblvacDept" runat="server" Text='<%#Bind("U_ReqdeptName") %>' ></asp:Label></div>
                                                </ItemTemplate>                                    
                                            </asp:TemplateField>
                                              <asp:TemplateField HeaderText="Vacant Position">
                                                <ItemTemplate>
                                                    <div align="left">&nbsp;<asp:Label ID="lblvacPosition" runat="server" Text='<%#Bind("U_EmpPosName") %>' ></asp:Label></div>
                                                </ItemTemplate>                                    
                                            </asp:TemplateField>
                                  ...
                                  <td>
                                      <asp:GridView ID="grdSummary" runat="server" CellPadding="4" AllowPaging="True" ShowHeaderWhenEmpty="true" EmptyDataText = "No Records Found"  CssClass="mGrid" HeaderStyle-Cssclass="GridBG" PagerStyle-CssClass="pgr"  AlternatingRowStyle-CssClass="alt" AutoGenerateColumns="false" Width="100%" PageSize="10" >
                                          <Columns>
                                             ...
                                             <asp:TemplateField HeaderText="Requisition Code" >
                                                <ItemTemplate>
                                                    <div align="left">&nbsp;<asp:Label ID="lblsReqcode" runat="server" Text='<%#Bind("U_RequestCode") %>' ></asp:Label></div>
                                                </ItemTemplate>                                    
                                            </asp:TemplateField>                            
                                             <asp:TemplateField HeaderText="Emp.Id">
                                                <ItemTemplate>
                                                    <div align="left">&nbsp;<asp:Label ID="lblsempcode" runat="server" Text='<%#Bind("U_Empid") %>' ></asp:Label></div>
                                                </ItemTemplate>                                    
                                            </asp:TemplateField> 
                                                <asp:TemplateField HeaderText="Emp.Name">
                                                <ItemTemplate>
                                                    <div align="left">&nbsp;<asp:Label ID="lblsempname" runat="server" Text='<%#Bind("U_Empname") %>' ></asp:Label></div>
                                                </ItemTemplate>                                    
                                            </asp:TemplateField>                                  
                                             <asp:TemplateField HeaderText="Emp.Department">
                                                <ItemTemplate>
                                                    <div align="left">&nbsp;<asp:Label ID="lblsempdept" runat="server" Text='<%#Bind("U_EmpdeptName") %>' ></asp:Label></div>
                                                </ItemTemplate>                                    
                                            </asp:TemplateField>
                                               <asp:TemplateField HeaderText="Emp.Position">
                                                <ItemTemplate>
                                                    <div align="left">&nbsp;<asp:Label ID="lblsempPos" runat="server" Text='<%#Bind("U_EmpPosName") %>' ></asp:Label></div>
                                                </ItemTemplate>                                    
                                            </asp:TemplateField>
                                               <asp:TemplateField HeaderText="Vacant Department">
                                                <ItemTemplate>
                                                    <div align="left">&nbsp;<asp:Label ID="lblsvacDept" runat="server" Text='<%#Bind("U_ReqdeptName") %>' ></asp:Label></div>
                                                </ItemTemplate>                                    
                                            </asp:TemplateField>
                                              <asp:TemplateField HeaderText="Vacant Position">
                                                <ItemTemplate>
                                                    <div align="left">&nbsp;<asp:Label ID="lblsvacPosition" runat="server" Text='<%#Bind("U_EmpPosName") %>' ></asp:Label></div>
                                                </ItemTemplate>                                    
                                            </asp:TemplateField>                                             
