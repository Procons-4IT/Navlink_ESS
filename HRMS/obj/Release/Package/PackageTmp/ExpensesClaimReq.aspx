<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/HRMS.Master" CodeBehind="ExpensesClaimReq.aspx.vb" Inherits="HRMS.ExpensesClaimReq" %>
                ...
                <ajx:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0"  CssClass="ajax__tab_yuitabview-theme" Width="100%" >
                  ...
                  <ContentTemplate>
                   <table width="100%" border="0" cellspacing="0" cellpadding="4" class="main_content">
                    ...
                    <asp:GridView ID="grdRequestExpenses" runat="server" CellPadding="4" RowStyle-CssClass="mousecursor" CssClass="mGrid" HeaderStyle-Cssclass="GridBG" 
                        PagerStyle-CssClass="pgr" AutoPostback="flash"   AlternatingRowStyle-CssClass="alt"   AutoGenerateColumns="false" Width="100%" ShowHeaderWhenEmpty="true" EmptyDataText="No records Found">
                                    <Columns>
