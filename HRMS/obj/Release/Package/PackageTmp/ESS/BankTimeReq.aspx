<%@ Page Title="Bank Time Request" Language="vb" AutoEventWireup="false" MasterPageFile="~/ESS/ESSMaster.Master" CodeBehind="BankTimeReq.aspx.vb" Inherits="HRMS.BankTimeReq" %>
...
<ContentTemplate>
 ...
 <tr>
    ...
    <td height="30" align="left" colspan="2" valign="bottom" background="images/h_bg.png"; style="border-bottom:1px dotted; border-color: #f45501; background-repeat:repeat-x">     
      <div >&nbsp; <asp:Label ID="Label3" runat="server" Text="Bank Time Request"  CssClass="subheader" style="float:left;" ></asp:Label>  <span ><asp:Label ID="lblNewTrip" runat="server" Text="" Visible="false"></asp:Label></span> </div>
      </td>    
 </tr>
  <tr>      
      <td align="center">
            ...
            <table width="99%" border="0" cellspacing="0" cellpadding="4" class="main_content">
              ...
              <td valign="top">  
                <ajx:TabContainer ID="TabContainer2" runat="server" ActiveTabIndex="0"  CssClass="ajax__tab_yuitabview-theme" Width="100%" >
                  <ajx:TabPanel  ID="TabPanel3" runat="server" HeaderText="Bank Time Request" ><ContentTemplate>
                   ...
                   <asp:TemplateField HeaderText="Approver Remarks">
                    ...
                    <ajx:TabPanel  ID="TabPanel1" runat="server" HeaderText="Bank Time Approved History" >
                        <ContentTemplate>
                          <table width="100%" border="0" cellspacing="0" cellpadding="3" class="main_content"><tr>
                                  <td><asp:GridView ID="grdSummary" runat="server" CellPadding="4" AllowPaging="True" ShowHeaderWhenEmpty="true"  CssClass="mGrid" HeaderStyle-Cssclass="GridBG" PagerStyle-CssClass="pgr"  AlternatingRowStyle-CssClass="alt" AutoGenerateColumns="false" Width="100%" PageSize="15" ><Columns>
                                          <asp:TemplateField HeaderText="Request Code">
                                              <ItemTemplate><div align="center">
                                          ...
                                          <asp:TemplateField HeaderText="Leave Name">
                                              <ItemTemplate><div align="center">
                                                  <asp:label ID="lblslvetype" runat="server" Text='<%#Bind("U_Z_LeaveName") %>'  ></asp:label></div></ItemTemplate></asp:TemplateField>
                                          <asp:TemplateField HeaderText="Start Date">
                                         ...
                                         <asp:TemplateField HeaderText="No.Of Days">
                                              <ItemTemplate><div align="left">&nbsp;<asp:Label ID="lblsdays" runat="server" Text='<%#Bind("U_Z_NoofDays") %>' ></asp:Label></div></ItemTemplate></asp:TemplateField>
                                                <asp:TemplateField HeaderText="Cash Out">
                                              <ItemTemplate><div align="left">&nbsp;<asp:Label ID="lblscashout" runat="server" Text='<%#Bind("U_Z_CashOut") %>' ></asp:Label></div></ItemTemplate></asp:TemplateField>
                                         <asp:TemplateField HeaderText="Reason">
                                 ...
                                 <td >Leave Type</td>
                                     ...
                                     <td>
                                      ...
                                      <tr>
                                       <td >No.of Hours</td>
                                     <td>
                                      <asp:TextBox ID="txttodate" CssClass="txtbox"  runat="server" onkeypress="AllowNumbers(this);checkDec(this);RemoveZero(this);" onkeyup="AllowNumbers(this);checkDec(this);RemoveZero(this);"></asp:TextBox>  
                                     </td>
                                      </tr>
                                     ...
                                     <td>
                                       ...
                                       <td ></td>
                                     <td>
                                      <asp:TextBox ID="txtnodays" CssClass="txtbox"  runat="server" Visible="false" onkeypress="AllowNumbers(this);checkDec(this);RemoveZero(this);" onkeyup="AllowNumbers(this);checkDec(this);RemoveZero(this);" ></asp:TextBox>                                             
                                     </td>
                                      </tr>
                                    <tr>
