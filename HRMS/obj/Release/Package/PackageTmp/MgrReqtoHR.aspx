<%@ Page Title="Request to HR" Language="vb" AutoEventWireup="false" MasterPageFile="~/HRMS.Master" CodeBehind="MgrReqtoHR.aspx.vb" Inherits="HRMS.MgrReqtoHR" %>
        ...
        <td>
            ...
            <table width="99%" border="0" cellspacing="0" cellpadding="4" class="main_content">
              ...
              <td valign="top">  
                <ajx:TabContainer ID="TabContainer2" runat="server" ActiveTabIndex="0"  CssClass="ajax__tab_yuitabview-theme" Width="100%" >
                  <ajx:TabPanel  ID="TabPanel3" runat="server" HeaderText="Employee Request to HR" ><ContentTemplate>
                          <table width="100%" border="0" cellspacing="0" cellpadding="3" class="main_content"><tr>
                                  <td><asp:GridView ID="grdRequesttohr" runat="server" CellPadding="4" AllowPaging="True" ShowHeaderWhenEmpty="true"  CssClass="mGrid" HeaderStyle-Cssclass="GridBG" PagerStyle-CssClass="pgr"  AlternatingRowStyle-CssClass="alt" AutoGenerateColumns="false" Width="100%" PageSize="10" >
                                  <Columns>
                                          <asp:TemplateField HeaderText="Request Code">
                                              <ItemTemplate><div align="center">
                                                  <asp:LinkButton ID="lbtndocnum" runat="server" Text='<%#Bind("clgCode") %>' onclick="lbtndocnum_Click" ></asp:LinkButton></div></ItemTemplate></asp:TemplateField>
                                          ...
                                          <asp:TemplateField HeaderText="Start Date">
                                              <ItemTemplate><div align="left">&nbsp;<asp:Label ID="lblstdate" runat="server" Text='<%#Bind("Recontact") %>' ></asp:Label></div></ItemTemplate></asp:TemplateField>
                                          <asp:TemplateField HeaderText="End Date">
                                              <ItemTemplate><div align="left">&nbsp;<asp:Label ID="lbledDate" runat="server" Text='<%#Bind("endDate") %>' ></asp:Label></div></ItemTemplate></asp:TemplateField>
         ...
         <div id="Div1" runat="server" class="DivCorner" style="border:solid 2px LightSteelBlue; width:100%;">    
            ...
            <asp:Panel ID="PanelNewRequest"  runat="server" Width="100%" BorderColor="LightSteelBlue"  BorderWidth="2">
                 ...
                 <td colspan="2">
                   <asp:TextBox ID="txtRemarks" CssClass="txtbox" Width="350px" Height="50px" runat="server" TextMode="MultiLine"></asp:TextBox>
                 </td>
                  <td  width="15%">                   
                  </td>                       
            </tr>           
             <tr>
                 ...
                 <td>
                   <asp:TextBox ID="txtstDate" CssClass="txtbox" Width="150px" runat="server" ></asp:TextBox>
                    <asp:TextBox ID="txtstTime" CssClass="txtbox" Width="150px" runat="server"  Visible="false"></asp:TextBox> 
                    <ajx:CalendarExtender ID="CalendarExtender1" Animated="true" Format="dd/MM/yyyy" runat="server" TargetControlID="txtstDate" CssClass= "cal_Theme1"></ajx:CalendarExtender>   
                 </td>
                  <td  width="15%">
                         <ajx:MaskedEditExtender ID="meeFromTime1" TargetControlID="txtstTime"
                                Mask="99:99"
                                MaskType="Time"
                                CultureName="en-us"
                              UserTimeFormat="TwentyFourHour" AutoComplete="false" MessageValidatorTip="true" ErrorTooltipEnabled="True" InputDirection="LeftToRight"
                                runat="server">
                                     ...
                                     <ajx:MaskedEditValidator ID="mevFromTime2" runat="server" ControlExtender="meeFromTime1" ControlToValidate="txtstTime" InvalidValueBlurredMessage="Enter correct time format" MaximumValue="23:59" IsValidEmpty="true" ValidationExpression="^([0-9][0-9])([:])([0-5][0-9])$"  Display="Static" ValidationGroup="Test"></ajx:MaskedEditValidator>
             ...
             <tr>
                 ...
                 <td>
                   <asp:TextBox ID="txtedDate" CssClass="txtbox" Width="150px" runat="server"></asp:TextBox>
                    <asp:TextBox ID="txtedTime" CssClass="txtbox" Width="150px" runat="server" Visible="false"></asp:TextBox>
                    <ajx:CalendarExtender ID="CalendarExtender2" Animated="true" Format="dd/MM/yyyy" runat="server" TargetControlID="txtedDate" CssClass= "cal_Theme1"></ajx:CalendarExtender>    
                 </td>
                  <td  width="15%"> 
                  <ajx:MaskedEditExtender ID="meeFromTime2" TargetControlID="txtedTime"
                                Mask="99:99"
                                MaskType="Time"
                                CultureName="en-us"
                              UserTimeFormat="TwentyFourHour" AutoComplete="false" MessageValidatorTip="true" ErrorTooltipEnabled="True" InputDirection="LeftToRight"
                                runat="server">
                                     ...
                                     <ajx:MaskedEditValidator ID="MaskedEditValidator1" runat="server" ControlExtender="meeFromTime2" ControlToValidate="txtedTime" InvalidValueBlurredMessage="Enter correct time format" MaximumValue="23:59" IsValidEmpty="true" ValidationExpression="^([0-9][0-9])([:])([0-5][0-9])$"  Display="Static" ValidationGroup="Test"></ajx:MaskedEditValidator>
             ...
             <tr>
                 ...
                 <td>
                    <asp:DropDownList ID="ddlStatus" CssClass="txtbox1" Width="150px"  runat="server" ></asp:DropDownList>   
                 </td>
                  <td  width="15%">    
                 ...
                 <td>
                  ...
                  <td  width="15%"> 
                   ...
                   <table width="100%" border="0" cellspacing="0" cellpadding="3" class="main_content">  
                       <tr>
                       <td valign="top">
                           <asp:TextBox ID="txtContent" runat="server" CssClass="txtbox" Width="350px" Height="150px" TextMode="MultiLine"></asp:TextBox>
                       </td>
                       </tr> 
                       </table> 
                   </ContentTemplate> 
