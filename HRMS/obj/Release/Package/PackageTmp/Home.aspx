<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/HRMS.Master" CodeBehind="Home.aspx.vb" Inherits="HRMS.Home" Theme="Theme1" %>
        ...
        <td>
          <asp:Panel ID="panelhome" runat="server" Width="100%"> 
            ...
            <table width="99%" border="0" cellspacing="0" cellpadding="4" class="main_content">
              <tr>
              <td valign="top">  
                <ajx:TabContainer ID="TabContainer2" runat="server" Width="100%" 
                  ...
                  <ajx:TabPanel  ID="TabPanel3" runat="server" HeaderText="Appraisal Notification" >
                   ...
                   <ContentTemplate>
                      <table width="100%" border="0" cellspacing="0" cellpadding="3" class="main_content">                                   
                                   <tr>
                                     <td style="padding-top:10px;">
                               <asp:GridView ID="grdActivity" runat="server" CellPadding="4" AllowPaging="True" ShowHeaderWhenEmpty="true"  CssClass="mGrid" HeaderStyle-Cssclass="GridBG" PagerStyle-CssClass="pgr"  AlternatingRowStyle-CssClass="alt" AutoGenerateColumns="false" Width="100%" PageSize="15" >
                            <Columns>
                                <asp:TemplateField HeaderText="Request Code">
                                              ...
                                              <ItemTemplate><div align="center">
                                                  <asp:label ID="lblempid" runat="server" Text='<%#Bind("U_Z_HREmpID") %>' ></asp:label></div></ItemTemplate></asp:TemplateField>
                                                   <asp:TemplateField HeaderText="Employee Name">
                                              <ItemTemplate><div align="center">
                                                  <asp:label ID="lblempname" runat="server" Text='<%#Bind("U_Z_HREmpName") %>' ></asp:label></div></ItemTemplate></asp:TemplateField>
