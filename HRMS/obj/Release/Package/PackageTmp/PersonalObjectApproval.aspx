<%@ Page Title="Personal Objective Approval" Language="vb" AutoEventWireup="false" MasterPageFile="~/HRMS.Master" CodeBehind="PersonalObjectApproval.aspx.vb" Inherits="HRMS.PersonalObjectApproval" %>
...
<table width="99%" border="0" cellspacing="0" cellpadding="4" class="main_content">
 <tr>
    ...
    <td height="30" align="left" colspan="2" valign="bottom" background="images/h_bg.png"; style="border-bottom:1px dotted; border-color: #f45501; background-repeat:repeat-x">     
      <div >&nbsp; <asp:Label ID="Label3" runat="server" Text="Personal Objective Approval"  CssClass="subheader" style="float:left;" ></asp:Label>  <span ><asp:Label ID="lblNewTrip" runat="server" Text="" Visible="false"></asp:Label></span> </div>
      </td>    
 </tr>
                                          ...
                                          <Columns>
                                              <asp:TemplateField HeaderText="Request Code" >
                                               ...
                                               <asp:TemplateField HeaderText="T&A Emp.ID">
                                                ...
                                                <asp:TemplateField HeaderText="Department Code" Visible="false">
                                                    <ItemTemplate>
                                                        <div align="left">&nbsp;<asp:Label ID="lbldeptcode" runat="server" Text='<%#Bind("U_DeptCode") %>' ></asp:Label></div>
                                                    </ItemTemplate>                                    
                                                </asp:TemplateField>
                                             <asp:TemplateField HeaderText="Employee Code">
                                                 ...
                                                 <asp:TemplateField HeaderText="Employee Name">
                                                    ...
                                                    <ItemTemplate>
                                                        <div align="left">&nbsp;<asp:Label ID="lblpeocode" runat="server" Text='<%#Bind("U_PeoobjCode") %>' ></asp:Label></div>
                                                    </ItemTemplate>                                    
                                                </asp:TemplateField>                                  
                                                 <asp:TemplateField HeaderText="Personel Objective Name">
                                                    <ItemTemplate>
                                                        <div align="left">&nbsp;<asp:Label ID="lblpeoname" runat="server" Text='<%#Bind("U_PeoobjName") %>' ></asp:Label></div>
                                                    </ItemTemplate>                                    
                                                </asp:TemplateField>
                                                   <asp:TemplateField HeaderText="Personel Objective Category">
                                                    <ItemTemplate>
                                                        <div align="left">&nbsp;<asp:Label ID="lblpeocate" runat="server" Text='<%#Bind("U_PeoCatDesc") %>' ></asp:Label></div>
                                                    </ItemTemplate>                                    
                                                </asp:TemplateField>
                                                 <asp:TemplateField HeaderText="Personel Objective Category" Visible="false">
                                                    <ItemTemplate>
                                                         <div align="left">&nbsp;<asp:Label ID="lblpeocategory" runat="server" Text='<%#Bind("U_PeoCategory") %>' Visible="false" ></asp:Label></div>
                                                     </ItemTemplate>                                    
                                                </asp:TemplateField>
                                                   <asp:TemplateField HeaderText="Weight">
                                                    <ItemTemplate>
                                                        <div align="left">&nbsp;<asp:Label ID="lblpeoweight" runat="server" Text='<%#Bind("U_Weight") %>' ></asp:Label></div>
                                                    </ItemTemplate>                                    
                                                </asp:TemplateField>
                                                   <asp:TemplateField HeaderText="Remarks">
                                                    <ItemTemplate>
                                                        <div align="left">&nbsp;<asp:Label ID="lblpeoremark" runat="server" Text='<%#Bind("U_Remarks") %>' ></asp:Label></div>
                                                    </ItemTemplate>                                    
                                                </asp:TemplateField>
