<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/HRMS.Master"
    CodeBehind="EmployeeProfile.aspx.vb" Inherits="HRMS.EmployeeProfile" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="4" class="main_content">
                                    ...
                                    <table width="99%" border="0" cellspacing="0" cellpadding="4" class="main_content">
                                        <tr>
                                            <td height="30" align="left" colspan="2" valign="bottom" background="images/h_bg.png"
                                                ...
                                                <div>
                                                    &nbsp;
                                                    <asp:Label ID="Label3" runat="server" Text="Employee Profile" CssClass="subheader"
                                                        ...
                                                        <ajx:TabPanel ID="TabPanel1" runat="server" HeaderText="Address">
                                                            <ContentTemplate>
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="3" class="main_content">
                                                                    <tr>
                                                                        <td width="15%">
                                                                            <a style="text-decoration: underline;">Work Address</a>
                                                                        </td>
                                                                        <td>
                                                                        </td>
                                                                        <td width="15%">
                                                                        ...
                                                                        <td width="15%">
                                                                            <a style="text-decoration: underline;">Home Address</a>
                                                                        </td>
                                                                        <td width="30%">
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:DropDownList ID="ddlWstate" CssClass="txtbox1" Width="150px" runat="server"
                                                                                Enabled="false">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                        <td width="15%">
                                                                        ...
                                                                        <td width="30%">
                                                                            <asp:DropDownList ID="ddlHState" CssClass="txtbox1" Width="150px" runat="server"
                                                                                Enabled="false">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:DropDownList ID="ddlWCountry" CssClass="txtbox1" Width="150px" runat="server"
                                                                        ...
                                                                        <td width="30%">
                                                                            <asp:DropDownList ID="ddlHCountry" CssClass="txtbox1" Width="150px" runat="server"
                                                                                Enabled="false" AutoPostBack="true">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                            ...
                                                            <ContentTemplate>
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="4" class="main_content">
                                                                    <tr>
                                                                        ...
                                                                        <td width="25%">
                                                                            <asp:DropDownList ID="ddlgender" CssClass="txtbox1" Width="160px" runat="server"
                                                                                Enabled="false">
                                                                        ...
                                                                        <td width="30%">
                                                                            <asp:DropDownList ID="ddlcitizenship" CssClass="txtbox1" Width="160px" runat="server"
                                                                                Enabled="false">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:DropDownList ID="ddlcouofbirth" CssClass="txtbox1" Width="160px" runat="server"
                                                                                Enabled="false">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <ajx:CalendarExtender ID="CalendarExtender1" Animated="true" Format="dd/MM/yyyy"
                                                                                runat="server" TargetControlID="txtexpdate" CssClass="cal_Theme1">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:DropDownList ID="ddlmarstatus" CssClass="txtbox1" Width="160px" runat="server"
                                                                                Enabled="false">
                                                                        ...
                                                                        <td>
                                                                            <a style="text-decoration: underline; font-weight: bold;">Emergency Contact Details</a>
                                                                        </td>
                                                                        <td>
                                                                        </td>
                                                                    </tr>
                                                        ...
                                                        <ajx:TabPanel ID="TabPanel7" runat="server" HeaderText="Education Details">
                                                            <ContentTemplate>
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="4" class="main_content">
                                                                    <tr>
                                                                        <td>
                                                                            <asp:GridView ID="grdedutype" Enabled="false" runat="server" CellPadding="4" RowStyle-CssClass="mousecursor"
                                                ...
                                                <div align="left">&nbsp;<asp:Label ID="lblline" runat="server" Text='<%#Bind("line") %>'></asp:Label></div> 
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Date From">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;
                                                                                                <asp:Label ID="lbldtfrom" runat="server" Text='<%#Bind("fromDate") %>'></asp:Label></div>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="To">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lbldtTo" runat="server" Text='<%#Bind("toDate") %>'></asp:Label></div>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Education Type">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="txtedutype" runat="server" Text='<%#Bind("name") %>'></asp:Label></div>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Institute">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;
                                                                                                <asp:Label ID="lblCWeight" runat="server" Text='<%#Bind("institute") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Major">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;
                                                                                                <asp:Label ID="lblmajor" runat="server" Text='<%#Bind("major") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Diploma">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;
                                                                                                <asp:Label ID="lblDiploma" runat="server" Text='<%#Bind("diploma") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                </Columns>
                                                            ...
                                                            <ContentTemplate>
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="4" class="main_content">
                                                                    <tr>
                                                                        ...
                                                                        <td width="40%">
                                                                            <asp:DropDownList ID="ddlbankname" CssClass="txtbox1" Width="150px" runat="server"
                                                                                Enabled="false">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                        <td width="20%">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="40%">
                                                                            <asp:Label ID="lblAccno" CssClass="txtbox" Width="150px" runat="server"></asp:Label>
                                                                        </td>
                                                                        <td width="20%">
                                                                        </td>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="40%">
                                                                            <asp:Label ID="lbliban" CssClass="txtbox" Width="150px" runat="server"></asp:Label>
                                                                        </td>
                                                                        <td width="20%">
                                                                        </td>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="40%">
                                                                            <asp:Label ID="lblbankbranch" CssClass="txtbox" Width="150px" runat="server"></asp:Label>
                                                                        </td>
                                                                        <td width="20%">
                                                                        </td>
                                                                        <td>
                ...
                <tr>
                    <td colspan="5" align="left">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Button ID="btnclose" CssClass="btn" Width="96px" runat="server" Text="Cancel" />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </td>
                </tr>
            </table>
