...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function Confirmation1() {
            var amount = document.getElementById("<%=txtReqno.ClientID %>").innerHTML;
            var msg = "Are you sure you want to withdraw travel request  "
                                        ...
                                        <div class="DivCorner" style="border: solid 2px LightSteelBlue; width: 100%;">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="4" class="main_content">
                                                <tr>
                                                    ...
                                                    <td width="15%">
                                                        <asp:Label ID="txtReqno" CssClass="txtbox" Width="150px" runat="server"></asp:Label>
                                                    </td>
                                                    <td width="10%">
                                                    </td>
                                                    <td width="15%">
