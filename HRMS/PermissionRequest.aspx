<%@ Page Title="Permission/Leave by hours Request" Language="vb" AutoEventWireup="false"
    MasterPageFile="~/HRMS.Master" CodeBehind="PermissionRequest.aspx.vb" Inherits="HRMS.PermissionRequest" %>
            ...
            <table width="99%" border="0" cellspacing="0" cellpadding="4" class="main_content">
                ...
                <tr>
                    <td height="30" align="left" colspan="2" valign="bottom" background="images/h_bg.png"
                        ...
                        <div>
                            &nbsp;
                            <asp:Label ID="Label3" runat="server" Text="Permission/Leave by hours Request" CssClass="subheader"
                ...
                <tr>
                  ...
                  <div align="center"><asp:label ID="lbllvetype" runat="server" Text='<%#Bind("Name") %>'  ></asp:label></div>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="From Time">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &nbsp;<asp:Label ID="lblfrtime" runat="server" Text='<%#Bind("U_Z_FromTime") %>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                       ...
                                       <ajx:CalendarExtender ID="CalendarExtender1" Animated="true" Format="dd/MM/yyyy" runat="server" TargetControlID="txttodate" CssClass= "cal_Theme1"></ajx:CalendarExtender>                                            
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <ajx:MaskedEditExtender ID="meeFromTime1" TargetControlID="txtfromtime" Mask="99:99"
                                                        MaskType="Time" CultureName="en-us" UserTimeFormat="TwentyFourHour" AutoComplete="false"
                                                        MessageValidatorTip="true" ErrorTooltipEnabled="True" InputDirection="LeftToRight"
                                                        runat="server">
                                                    </ajx:MaskedEditExtender>
                                                </td>
                                                <td>
                                                    <ajx:MaskedEditValidator ID="mevFromTime1" runat="server" ControlExtender="meeFromTime1"
                                                        ControlToValidate="txtfromtime" InvalidValueBlurredMessage="Enter correct time format"
                                                        MaximumValue="23:59" IsValidEmpty="true" ValidationExpression="^([0-9][0-9])([:])([0-5][0-9])$"
                                                        Display="Static" ValidationGroup="Test"></ajx:MaskedEditValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <ajx:MaskedEditExtender ID="meeFromTime2" TargetControlID="txtToTime" Mask="99:99"
                                                        MaskType="Time" CultureName="en-us" UserTimeFormat="TwentyFourHour" AutoComplete="false"
                                                        MessageValidatorTip="true" ErrorTooltipEnabled="True" InputDirection="LeftToRight"
                                                        runat="server">
                                                    </ajx:MaskedEditExtender>
                                                ...
                                                <td>
                                                    <ajx:MaskedEditValidator ID="mevFromTime2" runat="server" ControlExtender="meeFromTime2"
                                                        ControlToValidate="txtToTime" InvalidValueBlurredMessage="Enter correct time format"
                                                        MaximumValue="23:59" IsValidEmpty="true" ValidationExpression="^([0-9][0-9])([:])([0-5][0-9])$"
                                                        Display="Static" ValidationGroup="Test"></ajx:MaskedEditValidator>
                                                </td>
                                            </tr>
