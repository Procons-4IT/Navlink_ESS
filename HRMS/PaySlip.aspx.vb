...
Public Class PaySlip
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            Else
                ...
                Dim j As Integer
                For j = 4 To 12
                    '   ddlGstatus.Items.Add((time.AddMonths(j)).ToString("MMMM"))
                Next
                For i As Integer = -6 To 2
                    Dim [year] As String = System.DateTime.Now.AddYears(i).ToString("yyyy")
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnPrint.Click
        ...
        End Try
    End Sub
    'Private Function GetData(ByVal query As String) As ReportData
    '    Dim cmd As New SqlCommand(query)
    '    Using sda As New SqlDataAdapter()
    '        cmd.Connection = dbCon.con
    '        sda.SelectCommand = cmd
    '        Using dsreportdata As New ReportData()
    '            sda.Fill(dsreportdata, "DataTable1")
    '            Return dsreportdata
    '        End Using
    '    End Using
    'End Function
    ' Dim conString As String = "Data Source=SSR-PC;Initial Catalog=Lebense_Payroll; User ID=sa; Password= sql"
    'Dim dsreport As New ReportData()
    'Dim id As Integer
    'objEN.AppraisalNumber = Request.QueryString("AppraisalNo")
    'objEN.HomeEmpId = Request.QueryString("Empno")
    'id = Session("UserCode").ToString()
    'Dim cryt As New ReportDocument
    'cryt.Load(Server.MapPath("CReports\CRAppraisal.rpt"))
    'cryt.SetDatabaseLogon("sa", "sql", "SSR-PC", "Lebense_Payroll")
    'cryt.SetDataSource(dsreport)
    'CrystalReportViewer1.ReportSource = cryt
    'cryt.SetParameterValue("empid", id)
    '  CrystalReportViewer1.ReportSource = cryt
    'Response.Buffer = False
    'Response.ClearContent()
    'Response.ClearHeaders()
    'cryt.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, True, "Employee")
    'Response.[End]()
    'CrystalReportViewer1.ReportSource = cryt
    ' Using con As New SqlConnection(dbCon.con)

    ''  Response.Buffer = False
    'Crpt.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, True, "Employee")
    '' Response.[End]()
    ...
    Private Sub addCrystal(ByVal ds1 As DataSet, ByVal aChoice As String)
        ...
        Dim Crpt As New ReportDocument()
        Crpt.Load(Server.MapPath("Reports\Payslip.rpt"))
