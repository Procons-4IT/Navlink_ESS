<%@ Page Title="Self Appraisal" Language="vb" AutoEventWireup="false" MasterPageFile="~/HRMS.Master"
    CodeBehind="SelfAppraisal.aspx.vb" Inherits="HRMS.SelfAppraisal" %>
            ...
            <table width="99%" border="0" cellspacing="0" cellpadding="4" class="main_content">
                ...
                <tr>
                    <td height="30" align="left" colspan="2" valign="bottom" background="images/h_bg.png"
                        ...
                        <div>
                            &nbsp;
                            <asp:Label ID="Label3" runat="server" Text="Self Appraisal" CssClass="subheader"
                                                        ...
                                                        <ajx:TabPanel ID="TabPanel3" runat="server" HeaderText="Appraisal Request">
                                                            <ContentTemplate>
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="3" class="main_content">
                                                                    <tr>
                                                                        <td>
                                                                            <asp:GridView ID="grdRequestApp" runat="server" CellPadding="4" AllowPaging="True"
                                        ...
                                        <div class="DivCorner" style="border: solid 2px LightSteelBlue; width: 100%;">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="4" class="main_content">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="ddlperiod" CssClass="txtbox1" Width="160px" runat="server"
                                                            Enabled="false">
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td width="15%">
                                                    ...
                                                    <td width="30%">
                                                        <asp:DropDownList ID="ddlWstatus" CssClass="txtbox1" Width="160px" runat="server"
                                                            Enabled="false">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="20%" id="app" runat="server">
                                                          ...
                                                          <ajx:TabPanel ID="TabPanel1" runat="server" HeaderText="Business Objectives">
                                                                <ContentTemplate>
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="3" class="main_content">
                                                                        <tr>
                                                                            <td colspan="4">
                                                                                <asp:GridView ID="grdBusinessView" runat="server" CellPadding="4" ShowFooter="True"
                                                                                    AllowPaging="True" CssClass="mGrid" HeaderStyle-CssClass="GridBG" PagerStyle-CssClass="pgr"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="Self Rating">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &nbsp;<asp:DropDownList ID="ddlbusselfrate" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlbusselfrate_SelectedIndexChanged"
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="Self Remarks">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &nbsp;
                                                                                                    <asp:TextBox ID="lblBSelfRemark" runat="server" Text='<%#Bind("U_Z_SelfRemark") %>' TextMode="MultiLine"
                                                                                                        CssClass="txtbox" Width="120" Height="50"></asp:TextBox>
                                                                                                </div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="First Level Manager Remarks">
                                                                                            <ItemTemplate>
                                                                                                <div align="left" style="overflow-y:scroll; height:50px;" >
                                                                                                    &nbsp;
                                                                                                    <asp:Label ID="txtBfstmgrRemarks" runat="server" Text='<%#Bind("U_Z_MgrRemark") %>'
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="Second Level Manager Rating">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &nbsp;<asp:DropDownList ID="ddlsmgrfrate" runat="server" Enabled="false">
                                                                                                    </asp:DropDownList>
                                                                                                </div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="Second Level Manager Remarks">
                                                                                            <ItemTemplate>
                                                                                              <div align="left" style="overflow-y:scroll; height:50px;" >
                                                                                                    &nbsp;
                                                                                                    <asp:Label ID="lblBSecoMgrRemark" runat="server" Text='<%#Bind("U_Z_SrRemark") %>'
                                                                                                        CssClass="txtbox" Width="100"></asp:Label>
                                                                                                </div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="txtsBremarks" CssClass="txtbox" Width="200px" TextMode="MultiLine"
                                                                                    Height="40px" runat="server" Enabled="true"></asp:TextBox>
                                                                            </td>
                                                                            <td>
                                                                                Sr.Manager Remarks
                                                                            </td>
                                                                            <td>
                                                                                <asp:TextBox ID="txtBSrremarks" CssClass="txtbox" Width="200px" TextMode="MultiLine"
                                                                                    Height="40px" runat="server" Enabled="false"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="txtBLmremarks" CssClass="txtbox" Width="200px" TextMode="MultiLine"
                                                                                    Height="40px" runat="server" Enabled="false"></asp:TextBox>
                                                                            </td>
                                                                            <td>
                                                                                HR Remarks
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="txtBCHrremarks" CssClass="txtbox" Width="200px" TextMode="MultiLine"
                                                                                    Height="40px" runat="server" Enabled="false"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                            ...
                                                            <ajx:TabPanel ID="TabPanel2" runat="server" HeaderText="Personal Objectives">
                                                                <ContentTemplate>
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="4" class="main_content">
                                                                        <tr>
                                                                            <td colspan="4">
                                                                                <asp:GridView ID="grdPeopleview" runat="server" CellPadding="4" ShowFooter="True"
                                                                                    AllowPaging="True" Visible="false" CssClass="mGrid" HeaderStyle-CssClass="GridBG"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="Self Rating">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &nbsp;<asp:DropDownList ID="ddlpeselfrate" runat="server"  AutoPostBack="true" OnSelectedIndexChanged="ddlpeselfrate_SelectedIndexChanged"
                                                                                                        EnableViewState="true">
                                                                                                    </asp:DropDownList>
                                                                                                </div>
                                                                                            </ItemTemplate>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="Self Remarks">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &nbsp;
                                                                                                    <asp:TextBox ID="lblPSelfRemark" runat="server" Text='<%#Bind("U_Z_SelfRemark") %>' TextMode="MultiLine"
                                                                                                        CssClass="txtbox" Width="120" Height="50"></asp:TextBox>
                                                                                                </div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="First Level Manager Remarks">
                                                                                            <ItemTemplate>
                                                                                                 <div align="left" style="overflow-y:scroll; height:50px;" >
                                                                                                    &nbsp;
                                                                                                    <asp:Label ID="txtPfstmgrRemarks" runat="server" Text='<%#Bind("U_Z_MgrRemark") %>'
                                                                                                        CssClass="txtbox" Width="100"></asp:Label>
                                                                                                </div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="Second Level Manager Rating">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &nbsp;<asp:DropDownList ID="ddlsmgrrate" runat="server" Enabled="false" >
                                                                                                    </asp:DropDownList>
                                                                                                </div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="Second Level Manager Remarks">
                                                                                            <ItemTemplate>
                                                                                                <div align="left" style="overflow-y:scroll; height:50px;" >
                                                                                                    &nbsp;
                                                                                                    <asp:Label ID="lblPSecoMgrRemark" runat="server" Text='<%#Bind("U_Z_SrRemark") %>'
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="txtsPremarks" CssClass="txtbox" Width="200px" TextMode="MultiLine"
                                                                                    Height="40px" runat="server" Enabled="true"></asp:TextBox>
                                                                            </td>
                                                                            <td width="20%">
                                                                                Sr.Manager Remarks
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="txtPSrremarks" CssClass="txtbox" Width="200px" TextMode="MultiLine"
                                                                                    Height="40px" runat="server" Enabled="false"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="txtPLmremarks" CssClass="txtbox" Width="200px" TextMode="MultiLine"
                                                                                    Height="40px" runat="server" Enabled="false"></asp:TextBox>
                                                                            </td>
                                                                            <td>
                                                                                HR Remarks
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="txtPHrremarks" CssClass="txtbox" Width="200px" TextMode="MultiLine"
                                                                                    Height="40px" runat="server" Enabled="false"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                ...
                                                                <ContentTemplate>
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="4" class="main_content">
                                                                        <tr>
                                                                            <td colspan="4">
                                                                                <asp:GridView ID="grdCompetenceview" runat="server" CellPadding="4" AllowPaging="True"
                                                                                    ShowFooter="True" CssClass="mGrid" HeaderStyle-CssClass="GridBG" PagerStyle-CssClass="pgr"
                                                                                    AlternatingRowStyle-CssClass="alt" AutoGenerateColumns="False" Width="100%" 
                                                                                    Visible="false" ShowHeaderWhenEmpty="true" EmptyDataText="No records Found">
                                                                                    <Columns>
                                                                                        <asp:TemplateField HeaderText="Code" Visible="false">
                                                                                            <ItemTemplate>
                                                                                                <div align="center">
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="Self Rating">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &nbsp;<asp:DropDownList ID="ddlcompselfrate" runat="server"  AutoPostBack="true"
                                                                                                        OnSelectedIndexChanged="ddlcompselfrate_SelectedIndexChanged" EnableViewState="true">
                                                                                                    </asp:DropDownList>
                                                                                                </div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="Self Remarks">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &nbsp;
                                                                                                    <asp:Textbox ID="lblCSelfRemark" runat="server" Text='<%#Bind("U_Z_SelfRemark") %>' TextMode="MultiLine"
                                                                                                        CssClass="txtbox" Width="120" Height="50"></asp:Textbox>
                                                                                                </div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="First Level Manager Remarks">
                                                                                            <ItemTemplate>
                                                                                                 <div align="left" style="overflow-y:scroll; height:50px;" >
                                                                                                    &nbsp;
                                                                                                    <asp:Label ID="txtCfstmgrRemarks" runat="server" Text='<%#Bind("U_Z_MgrRemark") %>'
                                                                                                        CssClass="txtbox" Width="100"></asp:Label>
                                                                                                </div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="Second Level Manager Rating">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &nbsp;<asp:DropDownList ID="ddlcompsmgrrate" runat="server" Enabled="false">
                                                                                                    </asp:DropDownList>
                                                                                                </div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="Second Level Manager Remarks">
                                                                                            <ItemTemplate>
                                                                                                <div align="left" style="overflow-y:scroll; height:50px;" >
                                                                                                    &nbsp;
                                                                                                    <asp:Label ID="lblCSecoMgrRemark" runat="server" Text='<%#Bind("U_Z_SrRemark") %>'
                                                                                                        CssClass="txtbox" Width="100"></asp:Label>
                                                                                                </div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="txtsCremarks" CssClass="txtbox" Width="200px" TextMode="MultiLine"
                                                                                    Height="40px" runat="server" Enabled="true"></asp:TextBox>
                                                                            </td>
                                                                            <td width="20%">
                                                                                Sr.Manager Remarks
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="txtCSrremarks" CssClass="txtbox" Width="200px" TextMode="MultiLine"
                                                                                    Height="40px" runat="server" Enabled="false"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="txtCLmremarks" CssClass="txtbox" Width="200px" TextMode="MultiLine"
                                                                                    Height="40px" runat="server" Enabled="false"></asp:TextBox>
                                                                            </td>
                                                                            <td>
                                                                                HR Remarks
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="txtCHrremarks" CssClass="txtbox" Width="200px" TextMode="MultiLine"
                                                                                    Height="40px" runat="server" Enabled="false"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                ...
                                                                <ContentTemplate>
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="4" class="main_content">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="remarks" CssClass="txtbox" Width="200px" TextMode="MultiLine" Height="40px"
                                                            ...
                                                            <ajx:TabPanel ID="TabPanel6" runat="server" HeaderText="Final Rating" Visible="false">
                                                                <ContentTemplate>
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="4" class="main_content">
                                                                        <tr>
                                                                            <td colspan="4">
                                                                                <asp:GridView ID="grdfinalRate" runat="server" CellPadding="4" AllowPaging="True"
                                                                                    ...
                                                                                    <Columns>
                                                                                        <asp:TemplateField HeaderText="DocEntry" Visible="false">
                                                                                            <ItemTemplate>
                                                                                                <div align="center">
                                                                                                    <asp:Label ID="lblDocEntry" runat="server" Text='<%#Bind("DocEntry") %>'></asp:Label></div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="LineId" Visible="false">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &nbsp;<asp:Label ID="lblLineId" runat="server" Text='<%#Bind("LineId") %>'></asp:Label></div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="Objective Type">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &nbsp;<asp:Label ID="lblcomptype" runat="server" Text='<%#Bind("U_Z_CompType") %>'></asp:Label></div>
                                                                                            </ItemTemplate>
                                                                                            <FooterTemplate>
                                                                                                <div align="right">
                                                                                                    <asp:Label ID="lblfinalpay" runat="server" Text="Total(%)"></asp:Label>&nbsp;&nbsp;</div>
                                                                                            </FooterTemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="Average Rating">
                                                                                            <ItemTemplate>
                                                                                                <div align="Right">
                                                                                                    &nbsp;<asp:Label ID="lblavgrate" runat="server" Text='<%#Bind("U_Z_AvgComp") %>'></asp:Label></div>
                                                                                            </ItemTemplate>
                                                                                            <FooterTemplate>
                                                                                                <div align="right">
                                                                                                    <asp:Label ID="lbltotavgrate" runat="server"></asp:Label>&nbsp;</div>
                                                                                            </FooterTemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="HR Rating">
                                                                                            <ItemTemplate>
                                                                                                <div align="Right">
                                                                                                    &nbsp;<asp:Label ID="txtfinalrate" runat="server" Text='<%#Bind("U_Z_HRComp") %>'></asp:Label></div>
                                                                                            </ItemTemplate>
                                                                                            <FooterTemplate>
                                                                                                <div align="right">
                                                                                                    <asp:Label ID="lblfinalhrrate" runat="server"></asp:Label>&nbsp;</div>
                                                                                            </FooterTemplate>
                                                                                        </asp:TemplateField>
                                                                                    </Columns>
                                                                                    <HeaderStyle HorizontalAlign="Center" Height="25px" BackColor="#CCCCCC" />
                                        ...
                                        <table>
                                            <tr>
                                                <td colspan="5" align="center">
                                                    ...
                                                    <asp:Button ID="btnsaveAcceptance" CssClass="btn" runat="server" Text="Save Acceptance"
                                                        Visible="false" OnClientClick="return Confirmation1();" />
                                                    <asp:Button ID="btnUpdate" CssClass="btn" runat="server" Text="Update" Visible="false"
