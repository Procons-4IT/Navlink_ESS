...
Public Class ReturnLeaveApproval
    ...
    Protected Sub lbtndocnum_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Else
            ...
            Dim Rejoin As Label = CType(gv.FindControl("lblRetRejoin"), Label)
        ...
        Try
            ...
            ElseIf txtcode.Text <> "" Or txtcode.Text <> Nothing Then
                ...
                If objEN.AppStatus = "A" Then
                    objEN.DocMessage = "Return from leave request no. " & objEN.DocEntry & " has been approved based on rejoin date " & RetJoinDt & "" ' "Return From Leave Request"
                ElseIf objEN.AppStatus = "R" Then
                    objEN.DocMessage = "Return from leave request no. " & objEN.DocEntry & " has been Rejiected based on rejoin date " & RetJoinDt & "" ' "Return From Leave Request"
                 End If
